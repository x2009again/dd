...
set download=0
set try_download=1
set URL=https://raw.githubusercontent.com/x2009again/dd/master
...
echo     [1] by MoeClub [Linux](Debian10, DHCP or VNC Support)
...
set INITRD_SHA1=A0D65CBE2D76DD53B462D4EE7698CAC53CB398D0
...
call:CheckFile "%SystemDrive%\win32-loader\initrd.z02"
call:DownloadFile "!IMG_URL!/initrd.z03","%SystemDrive%\win32-loader\initrd.z03"
call:CheckFile "%SystemDrive%\win32-loader\initrd.z03"
call:DownloadFile "!IMG_URL!/initrd.zip","%SystemDrive%\win32-loader\initrd.zip"
